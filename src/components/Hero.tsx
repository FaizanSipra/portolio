        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-xl sm:text-2xl text-muted-foreground max-w-lg">
                  22-year-old Frontend Developer passionate about crafting beautiful digital experiences
                </p>
                
                <p className="text-lg text-muted-foreground/80 max-w-md">
                  Specializing in modern web development with HTML, CSS, JavaScript, and React. 
                  Experienced in WordPress development and creating responsive, user-friendly websites.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 justify-center lg:justify-start">
              <a 
                href="https://github.com/FaizanSipra" 
                target="_blank" 
              ...
              <a 
                href="https://www.linkedin.com/in/faizan-sipra-1684252a8" 
                target="_blank" 
                rel="noopener noreferrer"
              >
                <Button 
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              ...
              <div className="text-center lg:text-left">
                <div className="text-2xl md:text-3xl mb-1">9+</div>
            ...
            <div className="relative">
              ...
              <div className="relative z-10 group">
                <div className="relative w-80 h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden bg-gradient-to-br from-primary/10 to-secondary/10 backdrop-blur-sm border-4 border-background/50 shadow-2xl">
                  <ImageWithFallback
                    src={faizan}
                    alt="Faizan Ahmad - Frontend Developer"
